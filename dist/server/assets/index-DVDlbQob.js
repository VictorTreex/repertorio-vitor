import { r as reactExports, V as jsxRuntimeExports } from "./server-wz5jVVI4.js";
...
const iconLogo = "/assets/icon-logo-5xDzyelT.png";
const links = [
    ...
    motion.header,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#top", className: "flex items-center gap-2 font-semibold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: iconLogo, alt: "VitorDev", width: 1024, height: 1024, className: "h-8 w-8 object-contain drop-shadow-[0_0_10px_rgba(168,85,247,0.6)]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm tracking-wide", children: [
            "vitor",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: ".dev" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex items-center gap-6 text-sm text-muted-foreground", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: l.href,
...
const iconRocket = "/assets/icon-rocket-BcvH8epx.png";
const iconLock = "/assets/icon-lock-C3WoGZyD.png";
const iconClock = "/assets/icon-clock-yu2VxgIo.png";
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "top", className: "relative min-h-screen flex items-center justify-center px-6 pt-32 pb-20 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-grid opacity-40 [mask-image:radial-gradient(ellipse_at_center,black_30%,transparent_75%)]" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/3 -left-32 w-[500px] h-[500px] rounded-full bg-[var(--neon-purple)] opacity-30 blur-[140px] animate-float" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-10 -right-32 w-[500px] h-[500px] rounded-full bg-[var(--neon-blue)] opacity-25 blur-[140px] animate-float", style: { animationDelay: "2s" } }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-5xl mx-auto text-center", children: [
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "relative flex h-2.5 w-2.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative inline-flex h-2.5 w-2.5 rounded-full bg-emerald-400" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono tracking-wider text-emerald-300", children: "ONLINE" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-3 w-px bg-emerald-400/30" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-foreground/80", children: [
              "Aceitando ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-300 font-semibold", children: "2 novos projetos" }),
              " em Maio"
            ] })
          ]
        }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.h1,
        {
          ...
          children: [
            "Vitor",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient text-glow animate-gradient bg-gradient-to-r from-[var(--neon-purple)] via-[var(--neon-blue)] to-[var(--neon-cyan)] bg-clip-text text-transparent", children: "Dev" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.p,
        {
          ...
          children: [
            "Construo ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "sistemas reais" }),
            ", não templates."
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.p,
        {
          ...
          children: "Desenvolvedor Full Stack. Sistemas escaláveis, seguros e com identidade própria. Cada projeto é desenhado para ter performance e diferencial."
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          ].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative glass rounded-2xl p-5 flex items-center gap-4 overflow-hidden group hover:-translate-y-1 transition-transform", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-1 bg-gradient-to-r from-[var(--neon-purple)]/0 via-[var(--neon-purple)]/10 to-[var(--neon-cyan)]/0 opacity-0 group-hover:opacity-100 transition-opacity" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: s.icon, alt: "", loading: "lazy", width: 1024, height: 1024, className: "relative w-14 h-14 drop-shadow-[0_0_20px_rgba(168,85,247,0.5)]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative text-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl md:text-3xl font-bold text-gradient leading-none", children: s.n }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-1.5", children: s.l })
            ] })
          ] }, s.l))
        }
      )
...
const iconFullstack = "/assets/icon-fullstack-DpfDCCQy.png";
const iconSecurity = "/assets/icon-security-W0__atlT.png";
const iconPerformance = "/assets/icon-performance-ly5mLNDl.png";
function About() {
  const cards = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "sobre", className: "relative py-32 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.3em] text-[var(--neon-cyan)] mb-4", children: "// sobre mim" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-6xl font-bold leading-tight", children: [
        "Dev focado em ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "resultado real" }),
        ",",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        "não em demo bonita."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 0.15, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-8 text-lg text-muted-foreground max-w-3xl leading-relaxed", children: [
      "Sou um desenvolvedor full stack focado em criar sistemas reais, escaláveis e diferentes do padrão. Não gosto de soluções genéricas. Cada projeto que faço precisa ter",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: " identidade, performance e segurança" }),
      "."
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid md:grid-cols-3 gap-5", children: cards.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 0.1 * i, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group rounded-3xl p-7 h-full overflow-hidden border border-white/5 bg-gradient-to-br from-white/[0.04] to-white/[0.01] backdrop-blur-xl hover:-translate-y-1 transition-transform", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-20 -right-20 w-64 h-64 rounded-full bg-[var(--neon-purple)] opacity-10 blur-3xl group-hover:opacity-25 transition-opacity duration-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[var(--neon-purple)]/60 to-transparent" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: c.icon,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "relative font-semibold text-lg mb-2", children: c.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "relative text-sm text-muted-foreground leading-relaxed", children: c.desc })
    ] }) }, c.title)) })
  ] }) });
}
const skills = [
...
function Skills() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "skills", className: "relative py-32 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.3em] text-[var(--neon-cyan)] mb-4", children: "// stack" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-6xl font-bold", children: [
        "Habilidades que ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "entregam sistemas" }),
        "."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid md:grid-cols-2 gap-6", children: skills.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: i * 0.05, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-5 glow-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-baseline mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: s.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-mono", children: s.tag })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-2 rounded-full bg-secondary overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          initial: { width: 0 },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 text-xs text-muted-foreground font-mono", children: [
        s.level,
        "%"
      ] })
    ] }) }, s.name)) })
...
const iconDoramas = "/assets/icon-doramas-BQ90O-Wv.png";
const iconTeddo = "/assets/icon-teddo-mrpkYLVn.png";
const iconTreex = "/assets/icon-treexpay-DfrTrwwg.png";
const iconFrod = "/assets/icon-frodfast-B3y4_-yz.png";
const iconBots = "/assets/icon-bots-DM8Ubhyl.png";
const projects = [
  {
    name: "DoramasSuper",
...
function Projects() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "projetos", className: "relative py-32 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.3em] text-[var(--neon-cyan)] mb-4", children: "// projetos" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-6xl font-bold", children: [
        "Sistemas ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "em produção" }),
        "."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground max-w-2xl", children: "Cada um deles está rodando, processando dados reais e gerando valor — não é portfólio fake." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 grid md:grid-cols-2 gap-6", children: projects.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: i * 0.08, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.a,
      {
        href: p.href,
        target: p.href.startsWith("http") ? "_blank" : void 0,
        rel: "noreferrer",
        whileHover: { y: -6 },
        transition: { type: "spring", stiffness: 280, damping: 22 },
        className: `group relative block rounded-3xl overflow-hidden h-full border border-white/5 bg-gradient-to-br from-white/[0.04] to-white/[0.01] backdrop-blur-xl ${i === 0 ? "md:col-span-2" : ""}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `absolute -top-32 -right-24 w-[420px] h-[420px] rounded-full bg-gradient-radial ${p.glow} opacity-60 blur-3xl group-hover:opacity-100 transition-opacity duration-700` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[var(--neon-purple)]/60 to-transparent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative grid ${i === 0 ? "md:grid-cols-[260px_1fr]" : "grid-cols-[110px_1fr]"} gap-6 p-7`, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-[0.25em] text-[var(--neon-cyan)] font-mono", children: p.tag }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "h-5 w-5 text-muted-foreground group-hover:text-foreground group-hover:rotate-45 transition-all" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-2 text-2xl md:text-3xl font-bold tracking-tight", children: p.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground mt-1", children: p.url }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm md:text-base text-muted-foreground leading-relaxed", children: p.desc }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-5 flex flex-wrap gap-2", children: p.features.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
...
function Vision() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-32 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.3em] text-[var(--neon-cyan)] mb-4", children: "// visão de trabalho" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-6xl font-bold", children: [
        "Como eu ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "construo" }),
        "."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid md:grid-cols-2 gap-5", children: items.map((it, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: i * 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl p-7 h-full glow-border hover:-translate-y-1 transition-transform", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-5xl font-bold text-gradient font-mono mb-3", children: it.n }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold mb-2", children: it.t }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: it.d })
    ] }) }, it.n)) })
  ] }) });
}
function Contact() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contato", className: "relative py-32 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative glass rounded-3xl p-10 md:p-16 overflow-hidden text-center glow-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-32 left-1/2 -translate-x-1/2 w-[600px] h-[600px] rounded-full bg-[var(--neon-purple)] opacity-20 blur-[120px]" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-[0.3em] text-[var(--neon-cyan)]", children: "// contato" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-4 text-4xl md:text-6xl font-bold leading-tight", children: [
        "Tem um projeto?",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Vamos construir." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-lg text-muted-foreground max-w-xl mx-auto", children: "Orçamentos e projetos direto no WhatsApp. Resposta rápida, conversa honesta." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm font-mono text-muted-foreground", children: "+55 18 99191-3165" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-xs font-mono text-muted-foreground", children: "vitor.dev — full stack engineer · 2026" })
    ] })
  ] }) }) }) });
}
function Index() {
